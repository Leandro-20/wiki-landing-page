...
export const products: Product[] = [
  {
    ...
    variants: [
      { name: "Blanco", color: "#FFFFFF", image: "/images/catalog/sabanas-queen-blanco-puro.jpg" },
      { name: "Crema", color: "#F0EDE8", image: "/images/catalog/sabanas-queen-blanco.jpg" },
  ...
  },
  {
    ...
    variants: [
      { name: "Blanco", color: "#FFFFFF", image: "/images/catalog/sabanas-king-blanco-puro.jpg" },
